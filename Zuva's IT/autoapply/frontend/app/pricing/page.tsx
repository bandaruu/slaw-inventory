...
const plans = [
  {
    ...
    features: [
      'Limited applications/day',
      'Basic AI resume checks',
  ...
  },
  {
    ...
    price: '$999',
    period: 'year',
    description: 'The ultimate fully-automated job search experience.',
    features: [
      'Everything in Pro',
      'Portfolio website',
      'GitHub projects',
...
const comparison = [
  { feature: 'Daily Applications', free: 'Limited', pro: '20+', elite: 'Unlimited' },
  { feature: 'AI Resume Optimization', free: false, pro: true, elite: true },
  { feature: 'ATS Improvements', free: false, pro: true, elite: true },
  { feature: 'AI Cover Letters', free: false, pro: true, elite: true },
  { feature: 'Auto-Apply System', free: false, pro: false, elite: true },
  { feature: 'Portfolio Website', free: false, pro: false, elite: true },
  { feature: 'GitHub Projects', free: false, pro: false, elite: true },
  { feature: 'Interview Coaching', free: false, pro: false, elite: true },
];
...
export default function PricingPage() {
  ...
  const handleSelect = async (plan: string) => {
    ...
    // Elite checkout uses standard flow
    if (!isAuthenticated()) {
      return router.push('/register');
    }
    setLoading(plan);
    try {
      const res = await api.post('/api/payments/razorpay/order', { plan: plan.toLowerCase() });
      ...
      const options = {
        ...
        handler: async (response: any) => {
          ...
          toast.success(`🎉 Welcome to ${plan}! enjoy your new features.`);
